...
xcrun swiftc -parse-as-library macos/Usage.swift macos/Authentication.swift macos/CodexUsage.swift macos/tests/Tests.swift \
  -module-cache-path "$PWD/.build/swift-module-cache" -framework Security -lsqlite3 -o .build/usage-tests
.build/usage-tests "$@"
xcrun swiftc -parse-as-library macos/Usage.swift macos/Authentication.swift macos/CodexUsage.swift macos/AppModel.swift macos/tests/ModelTests.swift \
